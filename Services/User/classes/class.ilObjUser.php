...
/*		$query = "DELETE FROM udf_data  ".
	...
	*/
    ...
    ///// ADDED BY JAN
    /**
    * check if a matriculation number already exists
    * You may exclude a user from the check by giving his user id as 2nd paramter
    * @access public
    * @access static
    * @param string login name
    ...
    * @return boolean
    */
    public static function _matriculationExists($a_matriculation,$a_user_id = 0)
    {
        global $ilDB;
        if ($a_user_id == 0)
        {
        ...
        $q = "SELECT DISTINCT matriculation FROM usr_data ".
            "WHERE matriculation = ".$ilDB->quote($a_matriculation)." ".$clause;
        $r = $ilDB->query($q);
